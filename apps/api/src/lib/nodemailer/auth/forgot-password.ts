                    ...
                    <tbody>
                      <tr>
                        <td>
                          ...
                          <p style="font-size:12px;line-height:15px;margin:16px 0;color:#b7b7b7;text-align:left">Dies ist eine automatisch generierte Nachricht von promantis Helpdesk.</p>
                          <p style="font-size:12px;line-height:15px;margin:16px 0;color:#b7b7b7;text-align:left;margin-bottom:50px">© promantis Helpdesk.<br />Alle Rechte vorbehalten.</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
